...
class TafSummaryModel {
  ...
  Null? remiitedAmount;
  Null? remmitanceDate;
  Null? expenseClearanceStatus;
  Null? expenseClearanceAmount;
  Null? expenseClearanceDate;
  Null? amountApprovedBy;
  Null? amountApprovedOn;
  Null? tripReportStatus;
  Null? expenseClaimStatus;
  Null? finalApprovedAmount;
  Null? finalApprovalBy;
  Null? finalApprovalOn;
  Null? amountPaid;
  Null? amountPaidBy;
  Null? amountPaidOn;
  ...
  bool? mailSent;
  String? autoSrno;
  Null? payCollectionRemarks;
  Null? payCollectStatus;
  Null? finalSettlementApprovalStatus;
  Null? finalSettlementApprovedBy;
  Null? finalSettlementApprovedOn;
  Null? collectedAmount;
  Null? payCollectOn;
  String? budgetReportToApproval;
  String? budgetDirectorApproval;
  String? budgetReportToApOn;
  Null? budgetDirectorApOn;
  String? budgetReportToApRemarks;
  String? budgetDirectorApRemarks;
  Null? tripReportApproval;
  Null? tripReportApOn;
  Null? tripReportApRemarks;
  Null? expenseReportToApproval;
  Null? expenseDirectorApproval;
  Null? expenseReportToApOn;
  Null? expenseDirectorApOn;
  Null? expenseReportToApRemarks;
  Null? expenseDirectorApRemarks;
  String? validatedBy;
  String? validatedOn;
  Null? tripReportValidatedOn;
  Null? tripReportValidatedBy;
  Null? expenseValidatedOn;
  Null? expenseValidatedBy;
  Null? eReceiptAck;
  Null? eReceiptAckBy;
  Null? eReceiptAckOn;
  Null? eReceiptRemarks;
  Null? tAFCreationDate;
  ...
  Null? receiptAccounts;
  Null? receiptAccountsBy;
  Null? receiptAccountsOn;
  Null? lDRVoucherNo;
  Null? lDRVoucherID;
  Null? expenseAccountToApproval;
  Null? expenseAccountApOn;
  Null? expenseAccountToApRemarks;
  String? totalAmt1;
  String? indentorName;
  String? tAFApproval;
  String? tAFApproval1;
  ...
  Null? adminExpenseStatus;
  int? age;
  String? smeExpenseClaimStatus;
  String? smeClaimAmount;
  Null? smeExpValidationStatus;
